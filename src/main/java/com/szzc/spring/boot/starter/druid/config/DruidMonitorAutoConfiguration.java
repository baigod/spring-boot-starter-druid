...
public class DruidMonitorAutoConfiguration {
    ...
    public ServletRegistrationBean druidStatViewServlet(){
        ...
        logger.debug("loginUsername ---> " + properties.getLoginUsername() + "loginPassword ---> " + properties.getLoginPassword());
        //是否能够重置数据.
        servletRegistrationBean.addInitParameter("resetEnable",properties.getResetEnable()+"");
        logger.debug("resetEnable ---> " + properties.getResetEnable());
        return servletRegistrationBean;
    }
    ...
    public FilterRegistrationBean druidStatFilter(){
        ...
        logger.debug("urlPatterns ---> " + properties.getDruidWebStatFilter());

        //添加不需要忽略的格式信息.
        filterRegistrationBean.addInitParameter("exclusions",properties.getExclusions());
        logger.debug("exclusions ---> " + properties.getExclusions());
        return filterRegistrationBean;
    }
